---
title: Privacy Policy - About - aspose.cloud
...
Aspose defines the term **“Visitor”** as an individual that visits any page of our front-end website (for example [www.aspose.cloud](http://www.aspose.cloud)) or uses our products, web apps or mobile apps.
...
<p><br>Contact us at <span id="cloak92decc4fe532bee43413ff6d91367f13"><a href="mailto:sales@aspose.cloud">sales@aspose.cloud</a></span> and we will make reasonable efforts to promptly provide you with the information or assistance you need free of charge.</p>
...
<div class="cloudtablesmall"> <table><tbody><tr><th width="301">**Service**
 ...
 </td> </tr><tr><td width="301">Containerize.Discourse (forum.aspose.cloud)

 </td> <td width="301">To retain user settings on our free support forum

 </td> </tr><tr><td width="301">Containerize.Helpdesk (helpdesk.aspose.cloud)

 </td> <td width="301">To retain user settings on our paid support platform

 </td> </tr><tr><td width="301">Containerize.Mautic (drip.aspose.cloud)
...
<p>Aspose has a “Data Protection Officer” who is responsible for matters relating to privacy and data protection. This Data Protection officer can be reached by email: <span id="cloak30e3d4a4a34e37eefe649a63a2ffb182"><a href="mailto:dpo@aspose.cloud">dpo@aspose.cloud</a></span></p>
